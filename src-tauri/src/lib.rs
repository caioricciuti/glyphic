...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::plugins::prune_plugins,
            commands::plugins::plugin_details,
            commands::plugins::marketplace_list,
            commands::plugins::marketplace_add,
            commands::plugins::marketplace_remove,
            commands::plugins::marketplace_update,
            // Git
